...
class CreatMediaFilePage extends StatefulWidget {
  const CreatMediaFilePage({super.key});

  @override
  State<CreatMediaFilePage> createState() => _CreatMediaFilePageState();
}

class _CreatMediaFilePageState extends State<CreatMediaFilePage> {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: MyTextField.textFieldForm(
                        context, "Album name*", 350.w, albumController),
                  ),
                  ...images.map(
                    (e) {
                      return Container(
                  ...
                  GestureDetector(
                    onTap: () {
                      if (albumController.text.isNotEmpty) {
                        albumsModel.add(AlbumsModel(
                            albumsName: albumController.text, image: images));
                        Navigator.pop(context);
                      }
                    },
                    child: Container(
